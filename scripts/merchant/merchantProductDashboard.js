...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updatePaginationButtons(productList) {
    ...
    navigateToFirstPage.disabled = currentPage === 1;
    navigateToFirstPage.classList.toggle("border-primary", currentPage > 1);
    navigateToFirstPage.classList.toggle("border-gray-300", currentPage === 1);
    navigateToFirstPage.setAttribute("aria-disabled", currentPage === 1);

    navigateToPreviousPage.disabled = currentPage === 1;
    navigateToPreviousPage.classList.toggle("border-primary", currentPage > 1);
    navigateToPreviousPage.classList.toggle(
      "border-gray-300",
      currentPage === 1
    );
    navigateToPreviousPage.setAttribute("aria-disabled", currentPage === 1);

    navigateToNextPage.disabled = currentPage === totalPageCount;
    navigateToNextPage.classList.toggle(
      "border-primary",
    ...
    navigateToNextPage.setAttribute(
      "aria-disabled",
      currentPage === totalPageCount
    );

    navigateToLastPage.disabled = currentPage === totalPageCount;
    navigateToLastPage.classList.toggle(
      "border-primary",
      currentPage < totalPageCount
    );
    navigateToLastPage.classList.toggle(
    ...
    navigateToLastPage.setAttribute(
      "aria-disabled",
      currentPage === totalPageCount
    );
  }
  ...
  function renderProducts(productList = products) {
    ...
    const endDisplay = Math.min(startIndex + shownCount, totalItems);
